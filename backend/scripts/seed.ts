...
// Demo User
const EMAIL = "kai.vance@habiko.dev";
const PASSWORD = "password123";
const NAME = "Kai Vance";
...
const run = async () => {
  ...
  if (user) {
    // If 'demo' user found, delete and clear its data
    ...
    // if no 'demo' user found, create a fresh one
  ...
  // Generate logs for each habit to bulk insert them
  let totalLogs = 0;
  ...
  // First 4 habits of today are checked
