...
import { GEMINI_API_KEY, GEMINI_MODEL } from "../config/envConfig";
...
export const isAIEnabled = (): boolean => !!GEMINI_API_KEY;

// Markdown parser
export const parseJSON = <T = any>(text: string): T => {
