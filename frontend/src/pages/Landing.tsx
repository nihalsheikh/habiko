...
import OrbitingHabits from "../components/OrbitingHabits";
import type {
  FeatureItem,
  LandingHabitPreview,
...
const PREVIEW_HABITS: LandingHabitPreview[] = [
...
const PREVIEW_METRICS: LandingMetricPreview[] = [
    ...
    <div className="min-h-screen">
      <header className="max-w-6xl mx-auto px-6 py-5 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-lg">Habiko</span>
        </div>
      ...
      <footer className="max-w-6xl mx-auto px-6 py-8 text-center text-xs text-faint border-t divider">
        Built with MERN · Habiko © {new Date().getFullYear()}
      </footer>
    </div>
  );
}
