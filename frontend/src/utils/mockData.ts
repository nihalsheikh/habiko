...
let nextHabitId = 1;
const habit = (overrides?: MockHabitOverrides): MockHabit => ({
  _id: `h_${nextHabitId++}`,
  userId: mockUser._id,
  name: "",
  category: "Health",
...
export const mockLogs: HabitLog[] = buildLogs();

export const mockAI: MockAIStructure = {
